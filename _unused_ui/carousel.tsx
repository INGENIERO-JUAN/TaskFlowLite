...
function CarouselPrevious({ className, variant = "outline", size = "sm", ...props }: Omit<ButtonProps, "size"> & { size?: ButtonProps["size"] }) {
...
function CarouselNext({ className, variant = "outline", size = "sm", ...props }: Omit<ButtonProps, "size"> & { size?: ButtonProps["size"] }) {
